...
{
	Supports\Lerma,
	Interfaces\Lerma\IDrivers
};
use Exception AS Error;

return new class ( $this, $lerma -> {$lerma -> driver} ) implements IDrivers
{
	private $connect, $result, $lerma;
	...
	*/
	public function __construct ( Lerma $lerma, array $params = [] )
	{
		...
		$this -> connect = new SQLite3( ...$params );
	...
	public function bindParam( array ...$items )
	{
		...
		return $this -> lerma -> statement -> bind_param( ...$arguments );
	}
